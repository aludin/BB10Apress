...
device {
    CONFIG(debug, debug|release) {
        ...
        SOURCES +=  $$quote($$BASEDIR/src/AddressBook.cpp) \
                 $$quote($$BASEDIR/src/AsynchSearch.cpp) \
                 $$quote($$BASEDIR/src/ContactEditor.cpp) \
                 $$quote($$BASEDIR/src/ContactViewer.cpp) \
                 $$quote($$BASEDIR/src/main.cpp)

        HEADERS +=  $$quote($$BASEDIR/src/AddressBook.hpp) \
                 $$quote($$BASEDIR/src/AsynchSearch.h) \
                 $$quote($$BASEDIR/src/ContactEditor.hpp) \
                 $$quote($$BASEDIR/src/ContactViewer.hpp)
    }
