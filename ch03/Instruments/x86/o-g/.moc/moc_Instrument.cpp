...
static const char qt_meta_stringdata_Instrument[] = {
    "Instrument\0\0symbolChanged()\0priceChanged()\0"
    "QString\0symbol\0double\0price\0"
};
...
int Instrument::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = symbol(); break;
        case 1: *reinterpret_cast< double*>(_v) = price(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setSymbol(*reinterpret_cast< QString*>(_v)); break;
        }
        _id -= 2;
...
// SIGNAL 0
void Instrument::symbolChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Instrument::priceChanged()
{
